"""
Ensemble de macros-fonctions outils servant à intégrer les différents
composants d'un exercice pyexo dans une page web (titre, énoncé,
indication...). Il repose sur le module mkdocs-macros-plugin.
"""
